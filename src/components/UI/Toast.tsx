...
const config = {
  success: { icon: CheckCircle, cls: "bg-accent/10 border-accent/30 dark:bg-accent/20 dark:border-accent/40", iconCls: "text-accent", titleCls: "text-accent dark:text-accent-foreground", descCls: "text-foreground dark:text-foreground" },
  ...
  info:    { icon: Info,        cls: "bg-primary/10 border-primary/30 dark:bg-primary/20 dark:border-primary/40", iconCls: "text-primary", titleCls: "text-primary dark:text-primary-foreground", descCls: "text-foreground dark:text-foreground" },
