  ...
  return (
    <div className="flex h-screen bg-app-shell">
      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 min-w-0 ${desktopMargin}`}>
        <header className={`header-bar sticky top-0 z-40 ${mode === "horizontal" ? "" : "mx-5 my-0.5 rounded-b-4xl"}`}>
          <div className="flex items-center justify-between px-5 py-2.5">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <div className="header-pill">
                ...
                <div className="w-px h-4 bg-border/70 dark:bg-border/70" />
              ...
              <Link to="/profile" className="flex items-center gap-2 rounded-xl px-2 py-1.5 hover:bg-background/80 transition-all duration-200 border border-transparent hover:border-border/80" title={user?.name ?? user?.full_name ?? "Profile"}>
