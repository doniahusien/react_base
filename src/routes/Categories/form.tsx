        ...
        {({ errors, field, touch }) => (
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-end gap-3 pt-2 pb-4">
              ...
              <button type="submit" disabled={loadingForm || imageLoading} className="inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-90 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed transition-all">
