...
export default function CategoryForm() {
  ...
  return (
    <div className="space-y-0">
      <PageHeader
        title={editing ? "editCategory" : "addCategory"}
        subtitle={editing ? "updateCategoryInfo" : "createNewCategory"}
        icon={editing ? Library : Library}
        path={[
          { label: "dashboard", href: "/", icon: LayoutDashboard },
          { label: "categories", href: "/categories", icon: Library },
          { label: editing ? "editCategory" : "addCategory" }
        ]}
      />
