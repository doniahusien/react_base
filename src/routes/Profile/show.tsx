...
function InfoRow({ icon: Icon, label, children }: { icon: any; label: string; children: any }) {
  return <div className="flex items-start gap-3 py-3.5 border-b border-border last:border-0"><div className="mt-0.5 flex size-7 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary"><Icon width={13} height={13} /></div><div className="min-w-0 flex-1"><p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">{label}</p><div className="mt-0.5 text-sm font-medium text-foreground">{children}</div></div></div>;
}
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        <div className="rounded-2xl border border-border bg-card px-5 shadow-sm">
          <div className="flex items-center gap-2 border-b border-border py-4"><div className="flex size-7 items-center justify-center rounded-lg bg-emerald-soft text-emerald"><User width={13} height={13} /></div><h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground">{t("PROFILE.basicInfo")}</h3></div>
          <div className="py-1">
        ...
        <div className="rounded-2xl border border-border bg-card px-5 shadow-sm">
          <div className="flex items-center gap-2 border-b border-border py-4"><div className="flex size-7 items-center justify-center rounded-lg bg-primary/10 text-primary"><Mail width={13} height={13} /></div><h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground">{t("PROFILE.contactInfo")}</h3></div>
          <div className="py-1">
